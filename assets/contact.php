<?php
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        if ( empty($name) OR empty($subject) OR empty($lname) OR empty($message) OR !filter_var($email, FILTER_VALIDATE_EMAIL)) {
            ...
            echo "Por favor completá el formulario y volvé a intentarlo.";
            exit;
        }

        // Set the recipient email address.
        // FIXME: Update this to your desired email address.
        $recipient = "info@carbonneutralplus.com";
        ...
        echo "Hubo un problema con el envío, por favor volvé a intentarlo.";
    }
